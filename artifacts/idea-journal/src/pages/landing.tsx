      ...
      <main className="flex-1 flex items-center">
        <div className="w-full max-w-6xl mx-auto px-8 py-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200/60 p-2 space-y-1">
            {[
              { title: "Seed", description: "Save sparks before they disappear." },
              { title: "Plan", description: "Choose priorities and next steps." },
              { title: "Build", description: "Add progress notes as your research develops." },
              { title: "Share", description: "Publish finished thinking to a public portfolio." },
            ].map((step) => (
              <div
                key={step.title}
